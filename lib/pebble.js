...
exports.grant = function(req, done){
    ...
    var amount = req.body.amount,self=this;
            ...
            if(amount <= reserve.wallet && amount > 0){
                ...
                users.findByUsername(req.user.username, function(err, user){
                    ...
                    users.getUserPrime(user.username, function(userAccount){
                        ...
                        self.transfer(reserve, userAccount, amount, function(toWallet){
                            
                            done({grandStatus: 'success',reserveWallet: reserve.wallet, yourWallet: toWallet});
