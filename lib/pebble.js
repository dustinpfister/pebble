var mongoose = require('mongoose')
    ...
    // the function that is called to make the transfer
    /*
    makeTransfer = function (from, to, amount, done, fail) {
        ...
        if (from.wallet >= amount) {
                ...
                from.save(function () {
                    ...
                    to.save(function () {
                        ...
                        done({status: 'transfer successful.'});
                ...
                fail({status: 'insufficient pebble'});
        ...
        */
        ...
        accountRefCheck = function (accountRef, done) {
            ...
            if (typeof accountRef === 'object') {
                ...
                if (!(accountRef.wallet === undefined)) {
                    ...
                    console.log('looks like we all ready have it.');
                    ...
                    case 'username':
                        ...
                        console.log('getting prime user account!');

                        // get user prime account
                        users.getUserPrime(accountRef.username, function (account) {
                    ...
                    case 'accountNumber':
                        ...
                        console.log('getting by account Number!');

                        self.getAccount(accountRef.accountNumber, function (account) {
                    ...
                    case 'reserve':
                        ...
                        console.log('getting by reserve account!');

                        // get the reserve account
                        self.getReserve(function (account) {
...
exports.transfer = function (fromAccount, toAccount, amount, done, fail) {
    ...
    console.log('well we are getting this far at least.');
    ...
    accountRefCheck(fromAccount, function (fix) {
        ...
        accountRefCheck(toAccount, function (fix) {
            ...
            console.log('we cant get here for some reason?');
            
            toAccount = fix;

            // make transfer
            //makeTransfer(fromAccount, toAccount, amount, done, fail);
...
exports.give = function(req, done){
    ...
    if(req.body.giveTo){
        ...
        switch(req.body.giveTo){
            ...
            case 'reserve':
                ...
                // make the transfer
                this.transfer({getBy: 'username', username: req.user.username}, {getBy: 'reserve'}, req.body.amount, function (toWallet) {

                    done({giveStatus: 'give to reserve.'});
            ...
            default :
                ...
                done({giveStatus: 'fail, unkown giveTo.'});
        ...
        done({giveStatus: 'fail, no giveTo prop in request.'});
        
    }
        
    }else{
        
        done({giveStatus: 'fail, no amount prop in request.'});
    ...
    if (amount) {
        ...
        this.getReserve(function (reserve) {
            ...
            if (amount <= reserve.wallet && amount > 0) {
                ...
                // make the transfer
                self.transfer({getBy: 'reserve'}, {getBy: 'username', username: req.user.username}, amount, function (toWallet) {
