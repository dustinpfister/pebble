...
exports.startShop = function (scope, username, done) {
    ...
    scope.users.findByUsername(username, function (err, user) {
        ...
        if (user) {
            ...
            self.getPluginData(username, scope, function (pluginData, pluginIndex) {
                
                console.log('the plugin data:');
                ...
                scope.pebble.getAccount(user.primeAccount, function (userAccount) {
                    ...
                    if (userAccount.wallet >= 100) {
                        ...
                        if(pluginData.data.userShops.length < pluginData.data.maxShops){
                            ...
                            scope.pebble.getReserve(function (reserve) {
                                ...
                                if (reserve) {
                                    ...
                                    scope.pebble.transfer(userAccount, reserve, 100, function () {
                                        ...
                                        //pluginData.data.userShops.push(newShop.id);
                                        
                                        console.log('okay what the hell...');
                                        console.log(pluginIndex);
                                        console.log(user.pluginData[pluginIndex]);
...
// get pluginData for the given user, or make it if it is not there
exports.getPluginData = function (username, scope, done) {

    var self = this;

    scope.users.getPlugData(username, 'shops', function (pluginData, index) {
        ...
        if (pluginData.success) {
            ...
            self.makePluginData(username, scope, function (pluginData, index) {
