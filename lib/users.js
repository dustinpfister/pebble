...
exports.getUserPrime = function (username, done) {
        ...
        items.forEach(function (item) {
            ...
            ShopBase.findOne({
                ...
                self.findByUsername(shop.shopOwner, function (err, shopUser) {
                    ...
                    self.getUserPrime(shopUser.username, function (shopAccount) {

                        self.getUserPrime(user.username, function (userAccount) {
